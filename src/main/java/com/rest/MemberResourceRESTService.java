...
import com.service.MemberRegistration;
import com.service.MemberUnsubscription;
...
public class MemberResourceRESTService {
    ...
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    public Member lookupMemberByEmail(String email){
 ...
 /*   /** Deletes one member existing in data with the email provided.
    ...
    public Response deleteMember(String email){
        Response.ResponseBuilder builder = null;
        Member memberToDelete = lookupMemberByEmail(email);
